...
const HomeTheater = ({ addItem }) => {
  ...
  const filteredProducts = products?.filter((product) => {
    return product.category
      ?.toLowerCase()
      .includes("HOME THEATER RECLINER".toLowerCase());
  });
...
export default connect(null, mapDispatchToProps)(HomeTheater);
